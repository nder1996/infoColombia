...
export class GestionTareasService {
    ...
    private static readonly token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJBZG1pbmlzdHJhZG9yIiwiaWF0IjoxNzQwMDMyMDYyLCJleHAiOjE3NDAwMzU2NjJ9.dWVNdQtNqML0l94yPqh6DfYiCSbzalJ8cGXruuMojVE";
